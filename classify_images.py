...
def classify_images(images_dir, results_dic, model):
    ...
    # Iterate through all files in the results_dic processing each pet image (filename)
    # with the classifier function to get the classifier lable.
    # Note the key within results_dic contains the image file name. 
    #Therefore path = images_dir + filename (key)
    ...
    for key in results_dic:
        ...
        #Setup classifier variable using the classifier function
        ...
        if truth in model_label:
            ...
            #                   
            # if not found then added to results dictionary results_dic as NOT a match(0) extend list function
