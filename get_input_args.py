...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default='vgg', help='CNN Model Architecture - resnet, alexnet, or vgg')
    
    parser.add_argument('--dogfile', type=str, default='dognames.txt', help='Text file with dog names')
    
    
    # Replace "return None" with "return parser.parse_args()" parsed argument collection that 
